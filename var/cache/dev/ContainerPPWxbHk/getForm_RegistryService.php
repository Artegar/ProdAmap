...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\AdherantType' => function () {
    return ($this->privates['App\Form\AdherantType'] ?? $this->privates['App\Form\AdherantType'] = new \App\Form\AdherantType());
}, 'App\\Form\\AmapType' => function () {
    return ($this->privates['App\Form\AmapType'] ?? $this->privates['App\Form\AmapType'] = new \App\Form\AmapType());
}, 'App\\Form\\ContratType' => function () {
    return ($this->privates['App\Form\ContratType'] ?? $this->privates['App\Form\ContratType'] = new \App\Form\ContratType());
}, 'App\\Form\\FamilleType' => function () {
    return ($this->privates['App\Form\FamilleType'] ?? $this->privates['App\Form\FamilleType'] = new \App\Form\FamilleType());
}, 'App\\Form\\PanierType' => function () {
    return ($this->privates['App\Form\PanierType'] ?? $this->privates['App\Form\PanierType'] = new \App\Form\PanierType());
}, 'App\\Form\\ProducteurType' => function () {
    return ($this->privates['App\Form\ProducteurType'] ?? $this->privates['App\Form\ProducteurType'] = new \App\Form\ProducteurType());
...
}, 'App\\Form\\UtilisateurType' => function () {
    return ($this->privates['App\Form\UtilisateurType'] ?? $this->privates['App\Form\UtilisateurType'] = new \App\Form\UtilisateurType());
